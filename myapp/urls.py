...
from myapp.views import index,threatscan,email,url
...
urlpatterns = [
    ...
    path('threatscan/',threatscan,name='threatscan'),
    path('email_scan/',email,name='email'),
    path('url_scan/',url,name='url'),
